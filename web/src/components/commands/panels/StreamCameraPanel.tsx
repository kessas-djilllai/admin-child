...
import { Video, VideoOff, Camera, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      ...
      {!isActive ? (
        ...
        <Button variant="danger" size="sm" icon={<VideoOff size={16} />} onClick={stopStream} loading={isLoading}>إيقاف البث</Button>
      )}

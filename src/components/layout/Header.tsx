...
export function Header() {
  ...
  return (
    <header className="h-16 bg-white/80 dark:bg-surface-950/80 backdrop-blur-xl border-b border-surface-100 dark:border-surface-800 flex items-center justify-between px-6 sticky top-0 z-30">
